...
import com.anyuaning.droiden.activity.HomeActivity;
import com.anyuaning.droiden.R;
import com.anyuaning.droiden.bean.DialogDecorate;
import com.anyuaning.droiden.exception.CrashHandler;
...
//                                                android.os.Process.killProcess(android.os.Process.myPid());
    ...
    protected void dialog(DialogDecorate decorate, DialogInterface.OnClickListener okListener,
        ...
        mBuilder.setMessage((decorate.getTitle() == null) ? getString(R.string.hello) : decorate.getTitle());
        if (okListener != null) {
